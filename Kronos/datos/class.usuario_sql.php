...
class usuario_sql {
	...
	public function ObtieneXPks($p_parametros){
		...
		$query='select rut,contrasena,nombre,date_format(fecha_creacion,"%d/%m/%Y") fecha_creacion,correo
				from usuario
				where rut = :v_rut;';
	...
	public function InsertarRegistro($p_parametros) {
		...
		$query='insert into usuario
					(rut,contraseña,nombre,fecha_creacion,correo)
				values
					(:v_rut, :v_pass, :v_nombre,date_format(v:_fecha,"%d/%m/%Y") :v_fecha, :v_correo)
				';
